...
RUN echo '<!DOCTYPE html><html><head><meta http-equiv="refresh" content="0;url=vnc.html?autoconnect=true&resize=none&scaling=none"></head></html>' > /usr/share/novnc/index.html
